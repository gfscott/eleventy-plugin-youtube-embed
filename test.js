...
const invalidStrings = [
	{
		...
		str: "foo https://www.youtube.com/watch?v=hIs5StN8J-0",
	},
	{
		type: "With prepended text, with link",
		str: 'foo <a href="">https://www.youtube.com/watch?v=hIs5StN8J-0</a>',
	},
	{
		type: "With appended text",
		str: "https://www.youtube.com/watch?v=hIs5StN8J-0 bar",
	},
	{
		type: "With appended text, with link",
		str: '<a href="">https://www.youtube.com/watch?v=hIs5StN8J-0</a> bar',
	},
	{
		type: "Playlist URL",
		str: "https://www.youtube.com/playlist?list=PLv0jwu7G_DFVP0SGNlBiBtFVkV5LZ7SOU",
	},
];
...
validStrings.forEach(function(obj) {
	test(
		...
		(t) => {
			...
			t.is(
				buildEmbedCodeString(extractVideoId(idealCase), pluginDefaults),
	...
	test(
		...
		(t) => {
			...
			t.is(
				buildEmbedCodeString(extractVideoId(withLinks), pluginDefaults),
				'<div id="hIs5StN8J-0" class="eleventy-plugin-youtube-embed"style="position:relative;width:100%;padding-top: 56.25%;"><iframe style="position:absolute;top:0;right:0;bottom:0;left:0;width:100%;height:100%;" width="100%" height="100%" frameborder="0" title="Embedded YouTube video" src="https://www.youtube-nocookie.com/embed/hIs5StN8J-0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',
			);
		},
	);
	test(
      ...
      ${obj.str}
			...
			t.is(
				buildEmbedCodeString(extractVideoId(withWhitespace), pluginDefaults),
				'<div id="hIs5StN8J-0" class="eleventy-plugin-youtube-embed"style="position:relative;width:100%;padding-top: 56.25%;"><iframe style="position:absolute;top:0;right:0;bottom:0;left:0;width:100%;height:100%;" width="100%" height="100%" frameborder="0" title="Embedded YouTube video" src="https://www.youtube-nocookie.com/embed/hIs5StN8J-0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',
			);
		},
	);
	test(
      ...
      <a href="">
        ${obj.str}
			...
			t.is(
				buildEmbedCodeString(
					extractVideoId(withLinksAndWhitespace),
					pluginDefaults,
				),
				'<div id="hIs5StN8J-0" class="eleventy-plugin-youtube-embed"style="position:relative;width:100%;padding-top: 56.25%;"><iframe style="position:absolute;top:0;right:0;bottom:0;left:0;width:100%;height:100%;" width="100%" height="100%" frameborder="0" title="Embedded YouTube video" src="https://www.youtube-nocookie.com/embed/hIs5StN8J-0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',
			);
